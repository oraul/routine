...
The compiled core: how it is built, how it proves which commit built
it, and the parity rule every ported script must satisfy before its
bash original may ever be retired.
