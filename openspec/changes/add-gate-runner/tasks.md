...
- [x] 1.2 Red→green: emission is skipped cleanly when `ROUTINE_TICKET_DIR` is
...
- [x] 2.3 Red→green: seam contract — missing optional hook logs one line and
...
- [x] 3.2 Red→green: target checks against fixture git repos — dirty worktree
