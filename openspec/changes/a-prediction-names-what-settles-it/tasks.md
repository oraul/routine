...
- [x] 1.2 Red→green: `agents/analyst.md` requires its forecasts to name
      their grader — the phase or gate that will settle the claim —
      distinctly from probes it actually ran, pinned the same way in
