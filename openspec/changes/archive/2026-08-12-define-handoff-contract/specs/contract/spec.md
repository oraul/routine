...
The analyst gate SHALL fail once the ticket's telemetry records more than
3 failed `spec.lint` runs, naming the exhausted limit — the abort decision
is the script's, never the LLM's memory.
